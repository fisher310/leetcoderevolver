 ...
 *
 * <p>输入：rec1 = [0,0,1,1], rec2 = [1,0,2,1] 输出：false
 *
 * <p>提示：
 *
 * <p>两个矩形 rec1 和 rec2 都以含有四个整数的列表的形式给出。 矩形中的所有坐标都处于 -10^9 和 10^9 之间。 x 轴默认指向右，y 轴默认指向上。
 * 你可以仅考虑矩形是正放的情况。
 *
...
class Solution {
  ...
  public static void main(String[] args) {
    ...
    // true
    System.out.println(s.isRectangleOverlap(new int[] {7, 8, 13, 15}, new int[] {10, 8, 12, 20}));
    // false
    System.out.println(s.isRectangleOverlap(new int[] {0, 0, 1, 1}, new int[] {2, 2, 3, 3}));
    // false
    System.out.println(s.isRectangleOverlap(new int[] {2, 2, 3, 3}, new int[] {0, 0, 1, 1}));
  }
}
